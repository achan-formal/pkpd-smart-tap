...
Python code for running the hardware of the Auraflow smart tap on a Raspberry Pi 02w. Github repository is in https://github.com/achan-formal/pkpd-smart-tap/tree/main
